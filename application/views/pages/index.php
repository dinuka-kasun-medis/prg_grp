        ...
        <div class="row">
            ...
            <div class="col-sm-11">
                ...
                <h6>UCSC online printing service helps to save your vauble time and we can print
                    your documents witin short time. If you wish to use our services first you should
...
<main>
  ...
  <div class="container">
    ...
    <div class="row wow fadeIn" data-wow-delay="0.2s">
      ...
      <!--Main information-->
      <div class="col-lg-5">
        <h2 class="h2-responsive">UCSC Print Shop </h2>
        <hr>
        <p>UCSC online printing service helps to save your vauble time and we can print
                    your documents witin short time. If you wish to use our services first you should
...
<footer class="page-footer center-on-small-only">
  ...
  <div class="footer-copyright">
    <div class="container-fluid">
      © 2018. All Rights Reserved. <a href="#"> Programming Group 33</a>
